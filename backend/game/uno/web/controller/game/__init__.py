...
# http://localhost:5000/game/start_game?game_id=1&player_id=101&present=json
...
# http://localhost:5000/game/play_card?game_id=1&player_id=101&index=0&present=json
